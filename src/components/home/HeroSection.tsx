...
export function HeroSection({ onSearch }: HeroSectionProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-linear-to-b from-slate-100 via-slate-50 to-white px-4 pb-12 pt-8">
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:items-center">
          <div>
            ...
            <p className="mt-3 text-lg text-slate-600">
              Find Accessible Jobs That Match Your Skills
            </p>
          </div>
        ...
        <form
          ...
          className="mt-10 rounded-2xl bg-white p-6 shadow-lg ring-1 ring-slate-900/5"
        >
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <Button
              type="submit"
              className="h-12 rounded-lg bg-blue-600 px-8 text-base font-semibold text-white hover:bg-blue-700"
            >
              Search
            </Button>
          </div>
  ...
  return (
    <div className="relative w-full max-w-lg">
      <img
        ...
        className="mx-auto h-auto w-full max-h-[280px] object-contain object-bottom md:max-h-[340px]"
        width={1134}
        height={614}
        loading="eager"
        decoding="async"
